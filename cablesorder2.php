...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($required > 0) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            // Insert a new record
            $insertQuery = "INSERT INTO reordercables (BinLocation, PartName, PartNo, Category, Required, BackOrder, PurchaseOrder, Comments)
            SELECT BinLocation, PartName, ?, 'Cables', ?, (? - 0), 'NA', 'NA' FROM cables WHERE PartNo = ?";
