...
$query = "SELECT distinct projectmanager FROM jobs order by projectmanager asc";
$result = mysqli_query($conn, $query);
$options1 = "<option value=''>Select</option>";
while ($row = mysqli_fetch_assoc($result)) {
    $columnValue = $row['projectmanager'];
...
if ($result) {
    ...
    if ($record) {
        echo " <form method=\"post\" action=\"managejobs4-edit.php\">
                   ...
                   <h3><strong>Fitter: </strong>" . $record['allocatedfitter'] . "</h3>
